...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "button_create_account": MessageLookupByLibrary.simpleMessage(
      "Create Account",
    ),
    "button_get_started": MessageLookupByLibrary.simpleMessage("Get Started"),
    "button_login": MessageLookupByLibrary.simpleMessage("Login"),
    "button_please_wait": MessageLookupByLibrary.simpleMessage(
      "Please wait...",
    ),
    "button_reset_password": MessageLookupByLibrary.simpleMessage(
      "Reset Password",
    ),
    ...
    "hint_enter_confirm_password": MessageLookupByLibrary.simpleMessage(
      "Enter confirm password",
    ),
    "hint_enter_email": MessageLookupByLibrary.simpleMessage(
      "Enter your email",
    ),
    "hint_enter_name": MessageLookupByLibrary.simpleMessage("Enter your name"),
    "hint_enter_new_password": MessageLookupByLibrary.simpleMessage(
      "Enter new password",
    ),
    "hint_enter_password": MessageLookupByLibrary.simpleMessage(
      "Enter your password",
    ),
    "hint_enter_phone": MessageLookupByLibrary.simpleMessage(
    ...
    "text_agreed": MessageLookupByLibrary.simpleMessage("I\'m agree to the "),
    "text_and": MessageLookupByLibrary.simpleMessage(" and "),
    "text_didnt_get_otp": MessageLookupByLibrary.simpleMessage(
      "Didn’t get the OTP?",
    ),
    "text_dont_have_account": MessageLookupByLibrary.simpleMessage(
    ...
    "text_have_account": MessageLookupByLibrary.simpleMessage(
      "Do you have an account?",
    ),
    "text_or": MessageLookupByLibrary.simpleMessage("Or"),
    "text_privacy_policy": MessageLookupByLibrary.simpleMessage(
      "Privacy Policy",
    ),
    ...
    "title_description": MessageLookupByLibrary.simpleMessage("Description"),
    "title_error_title": MessageLookupByLibrary.simpleMessage("Opps!"),
    "title_forgot_password": MessageLookupByLibrary.simpleMessage(
      "Forgot Password",
    ),
    "title_home": MessageLookupByLibrary.simpleMessage("Home"),
    "title_introduction_1": MessageLookupByLibrary.simpleMessage(
      "The Simple Way to",
    ),
    "title_introduction_2": MessageLookupByLibrary.simpleMessage(
      "The Best Design",
    ),
    "title_introduction_sub_1": MessageLookupByLibrary.simpleMessage(
      "find the best!",
    ),
    "title_introduction_sub_2": MessageLookupByLibrary.simpleMessage(
      "Strategy!",
    ),
    ...
    "title_reset_password": MessageLookupByLibrary.simpleMessage(
      "Reset Password",
    ),
