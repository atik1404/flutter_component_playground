...
class Initial<T> implements ApiState<T> {
  const Initial();
...
class Loading<T> implements ApiState<T> {
  const Loading();
...
class Success<T> implements ApiState<T> {
...
class Error<T> implements ApiState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ApiStateCopyWith<T, $Res> {
