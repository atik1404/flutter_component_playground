...
return loginSubmitted(_that);case FetchProfile() when fetchProfile != null:
return fetchProfile(_that);case NavigateToHomeScreen() when navigateToHomeScreen != null:
return navigateToHomeScreen(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email)?  emailChanged,TResult Function( String password)?  passwordChanged,TResult Function()?  loginSubmitted,TResult Function()?  fetchProfile,TResult Function()?  navigateToHomeScreen,required TResult orElse(),}) {final _that = this;
switch (_that) {
case EmailChanged() when emailChanged != null:
...
return loginSubmitted();case FetchProfile() when fetchProfile != null:
return fetchProfile();case NavigateToHomeScreen() when navigateToHomeScreen != null:
return navigateToHomeScreen();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email)  emailChanged,required TResult Function( String password)  passwordChanged,required TResult Function()  loginSubmitted,required TResult Function()  fetchProfile,required TResult Function()  navigateToHomeScreen,}) {final _that = this;
switch (_that) {
case EmailChanged():
return emailChanged(_that.email);case PasswordChanged():
return passwordChanged(_that.password);case LoginSubmitted():
return loginSubmitted();case FetchProfile():
return fetchProfile();case NavigateToHomeScreen():
return navigateToHomeScreen();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email)?  emailChanged,TResult? Function( String password)?  passwordChanged,TResult? Function()?  loginSubmitted,TResult? Function()?  fetchProfile,TResult? Function()?  navigateToHomeScreen,}) {final _that = this;
switch (_that) {
case EmailChanged() when emailChanged != null:
return emailChanged(_that.email);case PasswordChanged() when passwordChanged != null:
return passwordChanged(_that.password);case LoginSubmitted() when loginSubmitted != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NavigateToHomeScreen);
}
